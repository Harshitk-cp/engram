...
func (m *mockMemoryStoreForConsolidation) RecallExhaustive(ctx context.Context, queryEmbedding []float32, agentID uuid.UUID, tenantID uuid.UUID, opts domain.RecallOpts) ([]domain.MemoryWithScore, error) {
	return nil, nil
}

func (m *mockMemoryStoreForConsolidation) RecallHybrid(ctx context.Context, query string, queryEmbedding []float32, agentID uuid.UUID, tenantID uuid.UUID, opts domain.RecallOpts) ([]domain.MemoryWithScore, error) {
	return nil, nil
}
...
func (m *mockMemoryStoreForConsolidation) GetRecentByType(ctx context.Context, agentID uuid.UUID, tenantID uuid.UUID, memType domain.MemoryType, limit int) ([]domain.MemoryWithScore, error) {
	return nil, nil
}
...
func (m *mockMemoryStoreForConsolidation) ArchiveExpiredSessionMemories(ctx context.Context) (int64, error) {
	return 0, nil
}

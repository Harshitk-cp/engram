...
func (c *GeminiClient) IngestConversation(ctx context.Context, messages []domain.Message) ([]domain.ExtractedConversationMemory, error) {
	var sb strings.Builder
	...
	result, err := c.complete(ctx, fmt.Sprintf(conversationIngestPrompt, sb.String()))
	if err != nil {

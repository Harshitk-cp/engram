...
func (c *AnthropicClient) DetectImplicitFeedback(ctx context.Context, memories []domain.Memory, conversation []domain.Message) ([]domain.ImplicitFeedback, error) {
...
func (c *AnthropicClient) ExtractEntities(ctx context.Context, content string) ([]domain.ExtractedEntity, error) {
	messages := []anthropicMessage{
...
func (c *AnthropicClient) DetectRelationships(ctx context.Context, memory *domain.Memory, similarMemories []domain.MemoryWithScore) ([]domain.DetectedRelationship, error) {
